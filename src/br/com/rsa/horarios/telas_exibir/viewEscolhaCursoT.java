 ...
 * @author 'Leonardo
 */
public class viewEscolhaCursoT extends javax.swing.JFrame {

    public viewEscolhaCursoT() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewEscolhaCursoT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewEscolhaCursoT().setVisible(true);
            }
        });
    }
