 ...
 * @author 'Leonardo
 */
public class ViewEscolhaCurso extends javax.swing.JFrame {

  

    public ViewEscolhaCurso() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewEscolhaCurso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewEscolhaCurso().setVisible(true);
            }
        });
    }
