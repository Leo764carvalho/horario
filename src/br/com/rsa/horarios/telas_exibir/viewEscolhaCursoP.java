 ...
 * @author 'Leonardo
 */
public class viewEscolhaCursoP extends javax.swing.JFrame {

   

    public viewEscolhaCursoP() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewEscolhaCursoP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewEscolhaCursoP().setVisible(true);
            }
        });
    }
