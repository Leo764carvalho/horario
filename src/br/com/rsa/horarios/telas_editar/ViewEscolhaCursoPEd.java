 ...
 * @author 'Leonardo
 */
public class ViewEscolhaCursoPEd extends javax.swing.JFrame {

  
    public ViewEscolhaCursoPEd() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewEscolhaCursoPEd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewEscolhaCursoPEd().setVisible(true);
            }
        });
    }
