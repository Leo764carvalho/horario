 ...
 * @author 'Leonardo
 */
public class viewEscolhaCursoDE extends javax.swing.JFrame {

   
    public viewEscolhaCursoDE() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewEscolhaCursoDE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewEscolhaCursoDE().setVisible(true);
            }
        });
    }
